...
//       playingField.innerHTML = '<div>Индустрия</div>';
...
//       let tableRound = document.createElement('table');
//       for (let i = 0; i < 2; i++) {
//         let tr = document.createElement('tr');
//         tableRound.appendChild(tr);
...
//           } if (i > 0 && j > 0) {
//             td.classList.add('table-result-round');
//             td.innerHTML = '';
//           }
//         }
//       }
...
//       tableRound.classList.add('game__table');
//       playingField.appendChild(table);
//       playingField.appendChild(tableRound);
...
//         const tableResultRound = document.querySelectorAll('.table-result-round');
//         let arrTableResultRound = [];
//         let arrRound = [];
//         tableResultRound.forEach((item, i) => {
//           if ((i + 1) % obj.players.length === 0) {
//             arrRound.push(item);
//             arrTableResultRound.push(arrRound);
//             arrRound = arrRound.slice(arrRound.length);
//           } else if ((i + 1) % obj.players.length !== 0) {
//             arrRound.push(item);
//           }
//         });
...
//         // console.log(arrTableResult[0][0].lastElementChild.value);
//         console.log(tableResultRound);
//         console.log(arrTableResultRound);
//         // console.log(Object.values(obj.players));

//         const okBtn = document.querySelectorAll('.ok');
//         okBtn.forEach((item, k) => {
//           const testInputValue = () => {
//             let test = true;
//             for (let i = 0; i < arrTableResult[0].length; i++) {
//               if (arrTableResult[k][i].lastElementChild.value === '') {
//                 test = false;
//               }
//             }
//             return test;
...
//                   obj.players[i].score = Number(arrTableResult[k][i].lastElementChild.value); 
//                   arrTableResult[k][i].innerHTML = arrTableResult[k][i].lastElementChild.value;
//                 }
//               } else if (k === 3) {
//                 for (let i = 0; i < obj.players.length; i++) {
//                   obj.players[i].score = Number(arrTableResult[k][i].lastElementChild.value); 
...
//                 for (let i = 0; i < arrTableResultRound[0].length; i++) {
//                   if (i === numTestScore) {
//                     arrTableResultRound[arrTableResultRound.length - 1][i].innerHTML = `
//                     1 <div style="font-size: 10px">(монет за игру: ${sortScore[i]})</div>`;
//                     obj.players[i].scoreRound += 1;
//                   } else {
//                     arrTableResultRound[arrTableResultRound.length - 1][i].innerHTML = `0 
...
//                   tr.appendChild(td);
//                   if (i === 0) {
//                     td.innerHTML = `Раунд №${arrTableResultRound.length + 1}`;
//                   } if (i > 0) {
//                     td.classList.add('table-result-round');
//                     td.innerHTML = '';
//                   }
...
//                 });
//                 endRound();
//                 // console.log(industryPlayers.players);
//               }
//             }
//           });
//         });
